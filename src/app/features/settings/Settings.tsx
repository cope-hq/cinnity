...
export enum SettingsPages {
  ...
  EmojisStickersPage,
  DeveloperToolsPage,
  // Cinny ports live here so upstream General/Notifications stay untouched.
  TweaksPage,
  AboutPage,
}
...
export function Settings({ initialPage, requestClose }: SettingsProps) {
  ...
  return (
    ...
    >
      ...
      {activePage === SettingsPages.TweaksPage && <Tweaks requestClose={handlePageRequestClose} />}
